...
public class TwoParameterInstructionConverter extends Z80InstructionConverter<TwoParameterInstruction> {
	...
	protected static interface InstructionAssemblyGenerator {
		...
		public byte[] generate(CompilationUnit compilationUnit, Parameter targetparameter, Parameter sourceparameter, List<MaskedOpcode<TwoParameterInstruction>> masks);
	...
	private static List<InstructionEntry> instructionlist = Arrays.asList(new InstructionEntry[]{
			...
			new InstructionEntry(ADD.class, Arrays.asList(
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xcf}, new byte[] {0x09}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xf8}, new byte[] {(byte) 0x80}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xff, 0x00}, new byte[] {(byte) 0xc6, 0x00}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xdf, (byte) 0xff, 0x00}, new byte[] {(byte) 0xdd, (byte) 0x86, 0x00}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xdf, (byte) 0xcf}, new byte[] {(byte) 0xdd, 0x09}, (r, v) -> null)
			...
			new InstructionEntry(EX.class, Arrays.asList(
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xff}, new byte[] {0x08}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xff}, new byte[] {(byte) 0xeb}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xff}, new byte[] {(byte) 0xe3}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xdf, (byte) 0xff}, new byte[] {(byte) 0xdd, (byte) 0xe3}, (r, v) -> null)
					), (c, t, s, m) -> generateEX(c, t, s, m)),
			new InstructionEntry(IN.class, Arrays.asList(
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xff, 0x00}, new byte[] {(byte) 0xdb, 0x00}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xff, (byte) 0xc7}, new byte[] {(byte) 0xed, 0x40}, (r, v) -> null)
			...
			new InstructionEntry(LD.class, Arrays.asList(
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xff}, new byte[] {0x02}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xff}, new byte[] {0x12}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xff}, new byte[] {0x0a}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xff}, new byte[] {0x1a}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xf8}, new byte[] {0x70}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xc7}, new byte[] {0x46}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xc0}, new byte[] {0x40}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xff}, new byte[] {(byte) 0xf9}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xc7, 0x00}, new byte[] {0x06, 0x00}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xdf, (byte) 0xff}, new byte[] {(byte) 0xdd, (byte) 0xf9}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xff, (byte) 0xff}, new byte[] {(byte) 0xed, (byte) 0x47}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xff, (byte) 0xff}, new byte[] {(byte) 0xed, (byte) 0x57}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xff, (byte) 0xff}, new byte[] {(byte) 0xed, (byte) 0x4f}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xff, (byte) 0xff}, new byte[] {(byte) 0xed, (byte) 0x5f}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xcf, 0x00, 0x00}, new byte[] {0x01, 0x00, 0x00}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xff, 0x00, 0x00}, new byte[] {0x22, 0x00, 0x00}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xff, 0x00, 0x00}, new byte[] {0x2a, 0x00, 0x00}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xff, 0x00, 0x00}, new byte[] {0x32, 0x00, 0x00}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xff, 0x00, 0x00}, new byte[] {0x3a, 0x00, 0x00}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xdf, (byte) 0xf8, 0x00}, new byte[] {(byte) 0xdd, 0x70, 0x00}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xdf, (byte) 0xc7, 0x00}, new byte[] {(byte) 0xdd, 0x46, 0x00}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xdf, (byte) 0xff, 0x00, 0x00}, new byte[] {(byte) 0xdd, (byte) 0x34, 0x00, 0x00}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xff, (byte) 0xcf, 0x00, 0x00}, new byte[] {(byte) 0xed, (byte) 0x43, 0x00, 0x00}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xff, (byte) 0xcf, 0x00, 0x00}, new byte[] {(byte) 0xed, (byte) 0x4b, 0x00, 0x00}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xdf, (byte) 0xff, 0x00, 0x00}, new byte[] {(byte) 0xdd, (byte) 0x21, 0x00, 0x00}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xdf, (byte) 0xff, 0x00, 0x00}, new byte[] {(byte) 0xdd, (byte) 0x22, 0x00, 0x00}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xdf, (byte) 0xff, 0x00, 0x00}, new byte[] {(byte) 0xdd, (byte) 0x2a, 0x00, 0x00}, (r, v) -> null)
					), (c, t, s, m) -> generateLD(c, t, s, m)),
			new InstructionEntry(OUT.class, Arrays.asList(
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xff, 0x00}, new byte[] {(byte) 0xd3, 0x00}, (r, v) -> null),
					new MaskedOpcode<TwoParameterInstruction>(new byte[] {(byte) 0xff, (byte) 0xc7}, new byte[] {(byte) 0xed, 0x41}, (r, v) -> null)
	...
	public byte[] convert(CompilationUnit compilationUnit, TwoParameterInstruction instruction) {
		...
		if (entry != null && entry.generator != null) {
			result = entry.generator.generate(compilationUnit, instruction.getTarget(), instruction.getSource(), entry.masks);
		}
		return result;
	}

	private static byte[] generateADCSBC(CompilationUnit compilationUnit, Parameter targetparameter, Parameter sourceparameter, List<MaskedOpcode<TwoParameterInstruction>> masks) {
		byte[] result = null;
		...
		if (targetparameter instanceof RegisterParameter &&
			...
			if (sourceindex != -1) {
				...
				result[1] = (byte) ((ExpressionParameter)sourceparameter).getExpressionValue(compilationUnit);
	...
	private static byte[] generateBITRESSET(CompilationUnit compilationUnit, Parameter targetparameter, Parameter sourceparameter, List<MaskedOpcode<TwoParameterInstruction>> masks) {
		byte[] result = null;
	...
	private static byte[] generateCALL(CompilationUnit compilationUnit, Parameter targetparameter, Parameter sourceparameter, List<MaskedOpcode<TwoParameterInstruction>> masks) {
		byte[] result = null;
		
		if (sourceparameter instanceof ExpressionParameter) {
			if (targetparameter != null && targetparameter instanceof ConditionParameter) {
				result = generateWithExpressionValue(compilationUnit, selectMask(masks.get(0)), (ExpressionParameter)sourceparameter, 1);
				...
				result = generateWithExpressionValue(compilationUnit, selectMask(masks.get(1)), (ExpressionParameter)sourceparameter, 1);
			}
		}
	...
	private static byte[] generateJP(CompilationUnit compilationUnit, Parameter targetparameter, Parameter sourceparameter, List<MaskedOpcode<TwoParameterInstruction>> masks) {
		byte[] result = null;
		...
		if (targetparameter == null) {
			if (sourceparameter instanceof RegisterIndirectAddressing) {
				...
				result = generateWithExpressionValue(compilationUnit, selectMask(masks.get(3)), (ExpressionParameter)sourceparameter, 1);
			}
		} else if (targetparameter instanceof ConditionParameter &&
				sourceparameter instanceof ExpressionParameter) {
			result = generateWithExpressionValue(compilationUnit, selectMask(masks.get(2)), (ExpressionParameter)sourceparameter, 1);
			Condition condition = ((ConditionParameter)targetparameter).getCondition();
			result[0] |= (condition.getOpcode() << 3);
		}
	...
	private static byte[] generateJR(CompilationUnit compilationUnit, Parameter targetparameter, Parameter sourceparameter, List<MaskedOpcode<TwoParameterInstruction>> masks) {
		byte[] result = null;
	...
	private static byte[] generateIN(CompilationUnit compilationUnit, Parameter targetparameter, Parameter sourceparameter, List<MaskedOpcode<TwoParameterInstruction>> masks) {
		byte[] result = null;
	...
	private static byte[] generateOUT(CompilationUnit compilationUnit, Parameter targetparameter, Parameter sourceparameter, List<MaskedOpcode<TwoParameterInstruction>> masks) {
		byte[] result = null;
		...
		if (targetparameter instanceof ExpressionParameter &&
			...
			result = selectMask(masks.get(0));
			result[1] = (byte) ((ExpressionParameter) targetparameter).getExpressionValue(compilationUnit);
	...
	private static byte[] generateEX(CompilationUnit compilationUnit, Parameter targetparameter, Parameter sourceparameter, List<MaskedOpcode<TwoParameterInstruction>> masks) {
		byte[] result = null;
		...
		if (targetparameter instanceof RegisterPairParameter &&
			...
			if (sourceparameter instanceof RegisterPairParameter) {
				...
				if (registerPair == RegisterPair.HL) {
					...
					result = generateIndexRegisters(compilationUnit, registerPair, masks.get(3).value);
				}
			}
		}
	...
	private static byte[] generateADD(CompilationUnit compilationUnit, Parameter targetparameter, Parameter sourceparameter, List<MaskedOpcode<TwoParameterInstruction>> masks) {
		byte[] result = null;
		...
		if (result == null && targetparameter instanceof RegisterPairParameter) {
			result = generateIndexRegisters(compilationUnit, ((RegisterPairParameter)targetparameter).getRegisterPair(), masks.get(4).value);
	...
	private static byte[] generateLD(CompilationUnit compilationUnit, Parameter targetparameter, Parameter sourceparameter, List<MaskedOpcode<TwoParameterInstruction>> masks) {
		byte[] result = null;
		...
		if (targetparameter instanceof RegisterIndirectAddressing &&
			...
			result = generateIndexRegisters(compilationUnit, ((RegisterPairParameter)sourceparameter).getRegisterPair(), masks.get(9).value);
		} else if (targetparameter instanceof RegisterParameter &&
			...
			result = selectMask(masks.get(11));
				...
				sourceparameter instanceof RegisterParameter &&
				((RegisterParameter)sourceparameter).getRegister() == Register.A) {
			result = selectMask(masks.get(12));
		} else if (targetparameter instanceof RegisterParameter &&
				((RegisterParameter)targetparameter).getRegister() == Register.A &&
				sourceparameter instanceof RegisterParameter &&
				((RegisterParameter)sourceparameter).getRegister() == Register.R) {
			result = selectMask(masks.get(13));
		} else if ((registerindex = getRegisterSSIndex(targetparameter)) != -1 &&
				sourceparameter instanceof ExpressionParameter) {
			result = generateWithExpressionValue(compilationUnit, selectMask(masks.get(14)), (ExpressionParameter)sourceparameter, 1);
			result[0] |= (registerindex << 4) & 0x30;
		} else if (targetparameter instanceof ImmediateAddressingParameter &&
				sourceparameter instanceof RegisterPairParameter &&
				((RegisterPairParameter)sourceparameter).getRegisterPair() == RegisterPair.HL) {
			result = generateWithImmediateValue(compilationUnit, selectMask(masks.get(15)), targetparameter, 1);
		} else if (targetparameter instanceof RegisterPairParameter &&
				((RegisterPairParameter)targetparameter).getRegisterPair() == RegisterPair.HL &&
				sourceparameter instanceof ImmediateAddressingParameter) {
			result = generateWithImmediateValue(compilationUnit, selectMask(masks.get(16)), sourceparameter, 1);
		} else if (targetparameter instanceof ImmediateAddressingParameter &&
				sourceparameter instanceof RegisterParameter &&
				((RegisterParameter)sourceparameter).getRegister() == Register.A) {
			result = generateWithImmediateValue(compilationUnit, selectMask(masks.get(17)), targetparameter, 1);
		} else if (targetparameter instanceof RegisterParameter &&
				((RegisterParameter)targetparameter).getRegister() == Register.A &&
				sourceparameter instanceof ImmediateAddressingParameter) {
			result = generateWithImmediateValue(compilationUnit, selectMask(masks.get(18)), sourceparameter, 1);
		} else if (targetparameter instanceof IndexedAddressingParameter &&
				(registerindex = getRegisterRIndex(sourceparameter)) != -1) {
			result = generateIndexedAddressing(compilationUnit, (IndexedAddressingParameter) targetparameter, masks.get(19).value);
			if (result != null) {
		...
		if (result == null) {
			if (sourceparameter instanceof IndexedAddressingParameter &&
				...
				result = generateIndexedAddressing(compilationUnit, (IndexedAddressingParameter) sourceparameter, masks.get(20).value);
				if (result != null) {
		...
		if (result == null) {
			if (targetparameter instanceof IndexedAddressingParameter &&
					sourceparameter instanceof ExpressionParameter) {
				result = generateIndexedAddressing(compilationUnit, (IndexedAddressingParameter) targetparameter, masks.get(21).value);
				if (result != null) {
					int value = ((ExpressionParameter)sourceparameter).getExpressionValue(compilationUnit);
		...
		if (result == null) {
			if (targetparameter instanceof ImmediateAddressingParameter &&
				...
				result = generateWithImmediateValue(compilationUnit, selectMask(masks.get(22)), targetparameter, 2);
				...
				result = generateWithImmediateValue(compilationUnit, selectMask(masks.get(23)), sourceparameter, 2);
				result[1] |= (registerindex << 4) & 0x38;
			} else if (targetparameter instanceof RegisterPairParameter &&
					...
					sourceparameter instanceof ExpressionParameter) {
				result = generateWithExpressionValue(compilationUnit, generateIndexRegisters(compilationUnit, ((RegisterPairParameter)targetparameter).getRegisterPair(), masks.get(24).value), (ExpressionParameter)sourceparameter, 2);
			} else if (targetparameter instanceof ImmediateAddressingParameter &&
					sourceparameter instanceof RegisterPairParameter &&
					(((RegisterPairParameter)sourceparameter).getRegisterPair() == RegisterPair.IX || ((RegisterPairParameter)sourceparameter).getRegisterPair() == RegisterPair.IY)) {
				result = generateWithImmediateValue(compilationUnit, generateIndexRegisters(compilationUnit, ((RegisterPairParameter)sourceparameter).getRegisterPair(), masks.get(25).value), targetparameter, 2);
			} else if (sourceparameter instanceof ImmediateAddressingParameter &&
					targetparameter instanceof RegisterPairParameter &&
					(((RegisterPairParameter)targetparameter).getRegisterPair() == RegisterPair.IX || ((RegisterPairParameter)targetparameter).getRegisterPair() == RegisterPair.IY)) {
				result = generateWithImmediateValue(compilationUnit, generateIndexRegisters(compilationUnit, ((RegisterPairParameter)targetparameter).getRegisterPair(), masks.get(26).value), sourceparameter, 2);
			}
		}
	...
	private static byte[] generateWithImmediateValue(CompilationUnit compilationUnit, byte[] result, Parameter parameter, int idx) {
		return generateWithExpressionValue(compilationUnit, result, ((ImmediateAddressingParameter)parameter).getValue(), idx);
	}

	private static byte[] generateWithExpressionValue(CompilationUnit compilationUnit, byte[] result, ExpressionParameter parameter, int idx) {
		int value = parameter.getExpressionValue(compilationUnit);
