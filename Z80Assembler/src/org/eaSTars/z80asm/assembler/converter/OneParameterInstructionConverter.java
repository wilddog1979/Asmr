...
public class OneParameterInstructionConverter extends Z80InstructionConverter<OneParameterInstruction> {
	...
	private static List<InstructionEntry> instructionlist = Arrays.asList(new InstructionEntry[]{
			new InstructionEntry(AND.class, Arrays.asList(
					...
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xff, 0x00}, new byte[] {(byte)0xe6, 0x00}),
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xdf, (byte) 0xff, 0x00}, new byte[] {(byte) 0xdd, (byte) 0xa6, 0x00})
			...
			new InstructionEntry(CP.class, Arrays.asList(
					...
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xff, 0x00}, new byte[] {(byte) 0xfe, 0x00}),
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xdf, (byte) 0xff, 0x00}, new byte[] {(byte) 0xdd, (byte) 0xbe, 0x00})
			), (c, i, m) -> generateSUBANDXORORCP(c, i, m)),
			new InstructionEntry(DEC.class, Arrays.asList(
					...
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xdf, (byte) 0xff}, new byte[] {(byte) 0xdd, 0x2b}),
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xdf, (byte) 0xff, 0x00}, new byte[] {(byte) 0xdd, 0x35, 0x00})
			), (c, i, m) -> generateINCDEC(c, i, m)),
			new InstructionEntry(DJNZ.class, Arrays.asList(
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xff, 0x00},  new byte[] {0x10, 0x00})
			...
			new InstructionEntry(INC.class, Arrays.asList(
					...
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xdf, (byte) 0xff}, new byte[] {(byte) 0xdd, 0x23}),
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xdf, (byte) 0xff, 0x00}, new byte[] {(byte) 0xdd, 0x34, 0x00})
			), (c, i, m) -> generateINCDEC(c, i, m)),
			new InstructionEntry(OR.class, Arrays.asList(
					...
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xff, 0x00}, new byte[] {(byte)0xf6, 0x00}),
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xdf, (byte) 0xff, 0x00}, new byte[] {(byte) 0xdd, (byte) 0xb6, 0x00})
			), (c, i, m) -> generateSUBANDXORORCP(c, i, m)),
			new InstructionEntry(POP.class, Arrays.asList(
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xcf}, new byte[] {(byte) 0xc1}),
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xdf, (byte) 0xff}, new byte[] {(byte) 0xdd, (byte) 0xe1})
			), (c, i, m) -> generatePUSHPOP(c, i, m)),
			new InstructionEntry(PUSH.class, Arrays.asList(
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xcf}, new byte[] {(byte) 0xc5}),
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xdf, (byte) 0xff}, new byte[] {(byte) 0xdd, (byte) 0xe5})
			), (c, i, m) -> generatePUSHPOP(c, i, m)),
			new InstructionEntry(RET.class, Arrays.asList(
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xff}, new byte[] {(byte) 0xc9}),
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xc7}, new byte[] {(byte) 0xc0})
			), (c, i, m) -> generateRET(c, i, m)),
			new InstructionEntry(RL.class, Arrays.asList(
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xff, (byte) 0xf8}, new byte[] {(byte) 0xca, 0x10}),
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xdf, (byte) 0xff, 0x00, (byte) 0xff}, new byte[] {(byte) 0xdd, (byte) 0xca, 0x00, 0x16})
			), (c, i, m) -> generateBitrotating(c, i, m)),
			new InstructionEntry(RLC.class, Arrays.asList(
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xff, (byte) 0xf8}, new byte[] {(byte) 0xca, 0x00}),
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xdf, (byte) 0xff, 0x00, (byte) 0xff}, new byte[] {(byte) 0xdd, (byte) 0xca, 0x00, 0x06})
			), (c, i, m) -> generateBitrotating(c, i, m)),
			new InstructionEntry(RR.class, Arrays.asList(
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xff, (byte) 0xf8}, new byte[] {(byte) 0xca, 0x18}),
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xdf, (byte) 0xff, 0x00, (byte) 0xff}, new byte[] {(byte) 0xdd, (byte) 0xca, 0x00, 0x1e})
			), (c, i, m) -> generateBitrotating(c, i, m)),
			new InstructionEntry(RRC.class, Arrays.asList(
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xff, (byte) 0xf8}, new byte[] {(byte) 0xca, 0x08}),
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xdf, (byte) 0xff, 0x00, (byte) 0xff}, new byte[] {(byte) 0xdd, (byte) 0xca, 0x00, 0x0e})
			), (c, i, m) -> generateBitrotating(c, i, m)),
			new InstructionEntry(RST.class, Arrays.asList(
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xc7}, new byte[] {(byte) 0xc7})
			), (c, i, m) -> generateRST(c, i, m)),
			new InstructionEntry(SLA.class, Arrays.asList(
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xff, (byte) 0xf8}, new byte[] {(byte) 0xca, 0x20}),
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xdf, (byte) 0xff, 0x00, (byte) 0xff}, new byte[] {(byte) 0xdd, (byte) 0xca, 0x00, 0x26})
			), (c, i, m) -> generateBitrotating(c, i, m)),
			new InstructionEntry(SRA.class, Arrays.asList(
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xff, (byte) 0xf8}, new byte[] {(byte) 0xca, 0x28}),
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xdf, (byte) 0xff, 0x00, (byte) 0xff}, new byte[] {(byte) 0xdd, (byte) 0xca, 0x00, 0x2e})
			), (c, i, m) -> generateBitrotating(c, i, m)),
			new InstructionEntry(SRL.class, Arrays.asList(
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xff, (byte) 0xf8}, new byte[] {(byte) 0xca, 0x38}),
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xdf, (byte) 0xff, 0x00, (byte) 0xff}, new byte[] {(byte) 0xdd, (byte) 0xca, 0x00, 0x3e})
			), (c, i, m) -> generateBitrotating(c, i, m)),
			new InstructionEntry(SUB.class, Arrays.asList(
					...
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xff, 0x00}, new byte[] {(byte)0xd6, 0x00}),
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xdf, (byte) 0xff, 0x00}, new byte[] {(byte) 0xdd, (byte) 0x96, 0x00})
			), (c, i, m) -> generateSUBANDXORORCP(c, i, m)),
			new InstructionEntry(XOR.class, Arrays.asList(
					...
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xff, 0x00}, new byte[] {(byte)0xee, 0x00}),
					new MaskedOpcode<OneParameterInstruction>(new byte[] {(byte) 0xdf, (byte) 0xff, 0x00}, new byte[] {(byte) 0xdd, (byte) 0xae, 0x00})
			), (c, i, m) -> generateSUBANDXORORCP(c, i, m))
	});
	...
	private static byte[] generateIndexedAddressing(CompilationUnit compilationUnit, IndexedAddressingParameter indexedAddressingParameter, byte[] bytes) {
		byte[] result = null;
	...
	private static byte[] generateIndexRegisters(CompilationUnit compilationUnit, RegisterPairParameter parameter, byte[] bytes) {
		byte[] result = null;
		
		RegisterPair registerpair = parameter.getRegisterPair();
		if (registerpair == RegisterPair.IX) {
			result = Arrays.copyOf(bytes, bytes.length);
		} else if (registerpair == RegisterPair.IY) {
			result = Arrays.copyOf(bytes, bytes.length);
	...
	private static byte[] generateINCDEC(CompilationUnit compilationUnit, OneParameterInstruction instruction, List<MaskedOpcode<OneParameterInstruction>> masks) {
		...
		if (registerindex != -1) {
			...
			result = generateIndexRegisters(compilationUnit, (RegisterPairParameter) parameter, masks.get(2).value);
		}
		if (result == null && parameter instanceof IndexedAddressingParameter) {
	...
	private static byte[] generatePUSHPOP(CompilationUnit compilationUnit, OneParameterInstruction instruction, List<MaskedOpcode<OneParameterInstruction>> masks) {
		...
		if (registerindex != -1) {
			...
			result = generateIndexRegisters(compilationUnit, (RegisterPairParameter) parameter, masks.get(1).value);
		}
