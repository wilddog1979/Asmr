  ...
  private static class InstructionArgumentProvider implements ArgumentsProvider {
    ...
    public Stream<? extends Arguments> provideArguments(ExtensionContext context) {
      return Stream.of(new Object[][] {
        ...
        {"INC [HL]", INC.class, RegisterIndirectAddressingParameter.class, "[HL]"},
        ...
        {"DEC [HL]", DEC.class, RegisterIndirectAddressingParameter.class, "[HL]"},
        ...
        {"SUB [HL]", SUB.class, RegisterIndirectAddressingParameter.class, "[HL]"},
        ...
        {"AND [HL]", AND.class, RegisterIndirectAddressingParameter.class, "[HL]"},
        ...
        {"XOR [HL]", XOR.class, RegisterIndirectAddressingParameter.class, "[HL]"},
        ...
        {"OR [HL]", OR.class, RegisterIndirectAddressingParameter.class, "[HL]"},
        ...
        {"CP [HL]", CP.class, RegisterIndirectAddressingParameter.class, "[HL]"},
        ...
        {"RLC [HL]", RLC.class, RegisterIndirectAddressingParameter.class, "[HL]"},
        ...
        {"RRC [HL]", RRC.class, RegisterIndirectAddressingParameter.class, "[HL]"},
        ...
        {"RL [HL]", RL.class, RegisterIndirectAddressingParameter.class, "[HL]"},
        ...
        {"RR [HL]", RR.class, RegisterIndirectAddressingParameter.class, "[HL]"},
        ...
        {"SLA [HL]", SLA.class, RegisterIndirectAddressingParameter.class, "[HL]"},
        ...
        {"SRA [HL]", SRA.class, RegisterIndirectAddressingParameter.class, "[HL]"},
        ...
        {"SRL [HL]", SRL.class, RegisterIndirectAddressingParameter.class, "[HL]"},
