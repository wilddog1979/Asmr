    ...
    public Stream<? extends Arguments> provideArguments(ExtensionContext context) {
      return Stream.of(new Object[][] {
        {new EX(new RegisterPairParameter(RegisterPair.AF), new RegisterPairParameter(RegisterPair.AFMarked)),
            new byte[] {0x08}},
        {new EX(new RegisterIndirectAddressingParameter(RegisterPair.SP), new RegisterPairParameter(RegisterPair.HL)),
            new byte[] {(byte) 0xe3}},
        {new EX(new RegisterPairParameter(RegisterPair.DE), new RegisterPairParameter(RegisterPair.HL)),
            new byte[] {(byte) 0xeb}},
        {new EX(new RegisterIndirectAddressingParameter(RegisterPair.SP), new RegisterPairParameter(RegisterPair.IX)),
            new byte[] {(byte) 0xdd, (byte) 0xe3}},
        {new EX(new RegisterIndirectAddressingParameter(RegisterPair.SP), new RegisterPairParameter(RegisterPair.IY)),
        ...
        {new ADD(new RegisterParameter(Register.A), new RegisterIndirectAddressingParameter(RegisterPair.HL)),
            new byte[] {(byte) 0x86}},
        ...
        {new ADC(new RegisterParameter(Register.A), new RegisterIndirectAddressingParameter(RegisterPair.HL)),
            new byte[] {(byte) 0x8e}},
        ...
        {new SBC(new RegisterParameter(Register.A), new RegisterIndirectAddressingParameter(RegisterPair.HL)),
            new byte[] {(byte) 0x9e}},
        ...
        {new JP(null, new RegisterIndirectAddressingParameter(RegisterPair.HL)), new byte[] {(byte) 0xe9}},
        {new JP(null, new RegisterIndirectAddressingParameter(RegisterPair.IX)),
            new byte[] {(byte) 0xdd, (byte) 0xe9}},
        {new JP(null, new RegisterIndirectAddressingParameter(RegisterPair.IY)),
            new byte[] {(byte) 0xfd, (byte) 0xe9}},
        ...
        {new BIT(new ExpressionParameter(new ConstantValueExpression(new ConstantValueParameter(0x0002)),
            8), new RegisterIndirectAddressingParameter(RegisterPair.HL)),
            new byte[] {(byte) 0xcb, 0x56}},
        {new BIT(new ExpressionParameter(new ConstantValueExpression(new ConstantValueParameter(0x0002)),
        ...
        {new CALL(new ConditionParameter(Condition.M), new ExpressionParameter(new ConstantValueExpression(
            new ConstantValueParameter(0x12ff)), 16)), new byte[] {(byte) 0xfc, (byte) 0xff,
              0x12}},
        {new LD(new RegisterIndirectAddressingParameter(RegisterPair.BC), new RegisterParameter(Register.A)),
            new byte[] {0x02}},
        {new LD(new RegisterIndirectAddressingParameter(RegisterPair.DE), new RegisterParameter(Register.A)),
            new byte[] {0x12}},
        {new LD(new RegisterParameter(Register.A), new RegisterIndirectAddressingParameter(RegisterPair.BC)),
            new byte[] {0x0a}},
        {new LD(new RegisterParameter(Register.A), new RegisterIndirectAddressingParameter(RegisterPair.DE)),
            new byte[] {0x1a}},
        {new LD(new RegisterIndirectAddressingParameter(RegisterPair.HL), new RegisterParameter(Register.B)),
            new byte[] {0x70}},
        {new LD(new RegisterIndirectAddressingParameter(RegisterPair.HL), new RegisterParameter(Register.C)),
            new byte[] {0x71}},
        {new LD(new RegisterIndirectAddressingParameter(RegisterPair.HL), new RegisterParameter(Register.D)),
            new byte[] {0x72}},
        {new LD(new RegisterIndirectAddressingParameter(RegisterPair.HL), new RegisterParameter(Register.E)),
            new byte[] {0x73}},
        {new LD(new RegisterIndirectAddressingParameter(RegisterPair.HL), new RegisterParameter(Register.H)),
            new byte[] {0x74}},
        {new LD(new RegisterIndirectAddressingParameter(RegisterPair.HL), new RegisterParameter(Register.L)),
            new byte[] {0x75}},
        {new LD(new RegisterIndirectAddressingParameter(RegisterPair.HL), new RegisterParameter(Register.A)),
            new byte[] {0x77}},
        {new LD(new RegisterParameter(Register.B), new RegisterIndirectAddressingParameter(RegisterPair.HL)),
            new byte[] {0x46}},
        {new LD(new RegisterParameter(Register.C), new RegisterIndirectAddressingParameter(RegisterPair.HL)),
            new byte[] {0x4e}},
        {new LD(new RegisterParameter(Register.D), new RegisterIndirectAddressingParameter(RegisterPair.HL)),
            new byte[] {0x56}},
        {new LD(new RegisterParameter(Register.E), new RegisterIndirectAddressingParameter(RegisterPair.HL)),
            new byte[] {0x5e}},
        {new LD(new RegisterParameter(Register.H), new RegisterIndirectAddressingParameter(RegisterPair.HL)),
            new byte[] {0x66}},
        {new LD(new RegisterParameter(Register.L), new RegisterIndirectAddressingParameter(RegisterPair.HL)),
            new byte[] {0x6e}},
        {new LD(new RegisterParameter(Register.A), new RegisterIndirectAddressingParameter(RegisterPair.HL)),
            new byte[] {0x7e}},
        ...
        {new LD(new RegisterIndirectAddressingParameter(RegisterPair.HL), new ExpressionParameter(
            new ConstantValueExpression(new ConstantValueParameter(0x4d)), 8)),
            new byte[] {0x36, 0x4d}},
