  ...
  private static class ConverterArgumentProvider implements ArgumentsProvider {
    ...
    public Stream<? extends Arguments> provideArguments(ExtensionContext context) {
      return Stream.of(new Object[][] {
        ...
        {new INC(new RegisterIndirectAddressingParameter(RegisterPair.HL)), new byte[] {0x34}},
        ...
        {new DEC(new RegisterIndirectAddressingParameter(RegisterPair.HL)), new byte[] {0x35}},
        ...
        {new SUB(new RegisterIndirectAddressingParameter(RegisterPair.HL)), new byte[] {(byte) 0x96}},
        ...
        {new AND(new RegisterIndirectAddressingParameter(RegisterPair.HL)), new byte[] {(byte) 0xa6}},
        ...
        {new XOR(new RegisterIndirectAddressingParameter(RegisterPair.HL)), new byte[] {(byte) 0xae}},
        ...
        {new OR(new RegisterIndirectAddressingParameter(RegisterPair.HL)), new byte[] {(byte) 0xb6}},
        ...
        {new CP(new RegisterIndirectAddressingParameter(RegisterPair.HL)), new byte[] {(byte) 0xbe}},
        ...
        {new RLC(new RegisterIndirectAddressingParameter(RegisterPair.HL)), new byte[] {(byte) 0xca, 0x06}},
        ...
        {new RRC(new RegisterIndirectAddressingParameter(RegisterPair.HL)), new byte[] {(byte) 0xca, 0x0e}},
        ...
        {new RL(new RegisterIndirectAddressingParameter(RegisterPair.HL)), new byte[] {(byte) 0xca, 0x16}},
        ...
        {new RR(new RegisterIndirectAddressingParameter(RegisterPair.HL)), new byte[] {(byte) 0xca, 0x1e}},
        ...
        {new SLA(new RegisterIndirectAddressingParameter(RegisterPair.HL)), new byte[] {(byte) 0xca, 0x26}},
        ...
        {new SRA(new RegisterIndirectAddressingParameter(RegisterPair.HL)), new byte[] {(byte) 0xca, 0x2e}},
        ...
        {new SRL(new RegisterIndirectAddressingParameter(RegisterPair.HL)), new byte[] {(byte) 0xca, 0x3e}},
